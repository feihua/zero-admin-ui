  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        name: '商品优选',
        icon: 'table',
        path: '/cms/preferredArea',
        component: './cms/PreferredArea',
      },
      {
        name: '用户举报',
        icon: 'table',
        path: '/cms/memberReport',
        component: './cms/MemberReport',
      },
      {
        name: '帮助分类',
        icon: 'table',
        path: '/cms/helpCategory',
        component: './cms/HelpCategory',
      },
      {
        name: '话题分类',
        icon: 'table',
        path: '/cms/topicCategory',
        component: './cms/TopicCategory',
      },
    ],
  },
  {
