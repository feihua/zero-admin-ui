...
import {addNotice, queryNoticeList, removeNotice, updateNotice, updateNoticeStatus} from './service';
 ...
 * @param fields
 */
const handleUpdate = async (fields: NoticeListItem) => {
...
const NoticeList: React.FC = () => {
  ...
  const columns: ProColumns<NoticeListItem>[] = [
    ...
    render: (dom, entity) => {
        switch (entity.noticeType) {
          case 1:
            return <Tag color={'success'}>通知</Tag>;
          case 2:
            return <Tag color={'blue'}>公告</Tag>;
        }
        return <>未知{entity.noticeType}</>;
      },
    },
    {
      title: '公告内容',
