...
import type {MemberGrowthLogListItem} from '../data.d';
import {queryMemberGrowthLogList} from '../service';
...
const MemberGrowthModal: React.FC<GrowthProps> = (props) => {
  ...
  const columns: ProColumns<MemberGrowthLogListItem>[] = [
    ...
    },
    {
      ...
      render: (dom, entity) => {
        switch (entity.changeType) {
          case 1:
            return <Tag color={'success'}>添加成长值</Tag>;
          case 2:
            return <Tag>减少成长值</Tag>;
        }
  ...
  return (
    <Modal
      ...
      onCancel={onCancel}
    >
      <ProTable<MemberGrowthLogListItem>
        toolBarRender={false}
        actionRef={actionRef}
        rowKey="id"
        search={false}
...
export default MemberGrowthModal;
