...
export interface AddressFormValueType extends Partial<AddressTableListItem> {
  target?: string;
  template?: string;
  type?: string;
  time?: string;
...
export interface UpdateAddressFormProps {
  onCancel: (flag?: boolean, formVals?: AddressFormValueType) => void;
  onSubmit: (values: AddressFormValueType) => Promise<void>;
  updateModalVisible: boolean;
  values: Partial<AddressTableListItem>;
}
