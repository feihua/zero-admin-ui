 ...
 * @param fields
 */
const handleAdd = async (fields: ReturnApplyListItem) => {
  const hide = message.loading('正在添加');
  try {
    await addReturnApply({ ...fields });
    hide();
 ...
 * @param fields
 */
const handleUpdate = async (fields: ReturnApplyFormValueType) => {
  const hide = message.loading('正在更新');
  try {
    await updateReturnApply({
      name: fields.name,
    ...
    <PageContainer>
      ...
      <ModalForm
        ...
        onFinish={async (value) => {
          const success = await handleAdd(value as ReturnApplyListItem);
          if (success) {
