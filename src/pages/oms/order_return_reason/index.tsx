 ...
 * @param fields
 */
const handleUpdate = async (fields: ReturnReasonFormValueType) => {
  const hide = message.loading('正在更新');
  try {
    await updateReturnReason({
      name: fields.name,
    ...
    <PageContainer>
      ...
      <ModalForm
        ...
        onFinish={async (value) => {
          const success = await handleAdd(value as ReturnReasonListItem);
          if (success) {
