...
export interface CategoryFormValueType extends Partial<CategoryListItem> {
  target?: string;
  template?: string;
  type?: string;
  time?: string;
...
export interface UpdateCategoryFormProps {
  onCancel: (flag?: boolean, formVals?: CategoryFormValueType) => void;
  onSubmit: (values: CategoryFormValueType) => Promise<void>;
  updateModalVisible: boolean;
  values: Partial<CategoryListItem>;
}

const UpdateCategoryForm: React.FC<UpdateCategoryFormProps> = (props) => {
