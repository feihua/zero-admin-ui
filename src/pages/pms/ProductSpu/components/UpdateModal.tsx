...
export interface UpdateModalProps {
  ...
  currentData: Partial<ProductSpuListItem>;
}
...
const UpdateModal: React.FC<UpdateModalProps> = (props) => {
  ...
  const handleFinish = (values: { [key: string]: any }) => {
    if (onSubmit) {
      onSubmit(values as ProductSpuListItem);
    }
  };
  ...
  const renderContent = () => {
    return (
      <>
        ...
        >
            <Input id="update-categoryId" placeholder={'请输入商品分类ID!'}/>
         </FormItem>
        <FormItem
          name="categoryIds"
          label="商品分类ID集合"
        ...
        >
            <Input id="update-categoryIds" placeholder={'请输入商品分类ID集合!'}/>
         </FormItem>
        <FormItem
          name="categoryName"
          label="商品分类名称"
        ...
        >
            <Input id="update-categoryName" placeholder={'请输入商品分类名称!'}/>
         </FormItem>
        <FormItem
          name="brandId"
          label="品牌ID"
        ...
        >
            <Input id="update-brandId" placeholder={'请输入品牌ID!'}/>
         </FormItem>
        <FormItem
          name="brandName"
          label="品牌名称"
        ...
        >
            <Input id="update-brief" placeholder={'请输入简介!'}/>
         </FormItem>
        <FormItem
          name="description"
          label="详细描述"
        ...
        >
            <Input id="update-description" placeholder={'请输入详细描述!'}/>
         </FormItem>
        <FormItem
          name="albumPics"
        ...
        >
            <Input id="update-priceRange" placeholder={'请输入价格区间!'}/>
         </FormItem>
        <FormItem
          name="publishStatus"
        ...
        >
            <Input id="update-detailTitle" placeholder={'请输入详情标题!'}/>
         </FormItem>
        <FormItem
          name="detailDesc"
          label="详情描述"
        ...
        >
            <Input id="update-detailDesc" placeholder={'请输入详情描述!'}/>
         </FormItem>
        <FormItem
          name="detailHtml"
          label="产品详情网页内容"
