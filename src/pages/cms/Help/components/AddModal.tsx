...
const AddModal: React.FC<CreateFormProps> = (props) => {
  ...
  const handleFinish = (values: HelpListItem) => {
    if (onSubmit) {
      onSubmit(values);
    }
  };
  ...
  const renderContent = () => {
    return (
      <>
            ...
            >
              <Input id="create-title" placeholder={'请输入标题!'}/>
            </FormItem>
            <FormItem
              name="showStatus"
            ...
            >
              <Input id="create-readCount" placeholder={'请输入阅读量!'}/>
            </FormItem>
            <FormItem
              name="content"
              label="内容"
            ...
            >
              <Input id="create-content" placeholder={'请输入内容!'}/>
            </FormItem>
