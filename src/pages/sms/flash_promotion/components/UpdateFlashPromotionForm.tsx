...
export interface FlashPromotionFormValueType extends Partial<FlashPromotionListItem> {
  target?: string;
  template?: string;
  type?: string;
  time?: string;
...
export interface UpdateFlashPromotionFormProps {
  onCancel: (flag?: boolean, formVals?: FlashPromotionFormValueType) => void;
  onSubmit: (values: FlashPromotionFormValueType) => Promise<void>;
  updateModalVisible: boolean;
  values: Partial<FlashPromotionListItem>;
}

const UpdateFlashPromotionForm: React.FC<UpdateFlashPromotionFormProps> = (props) => {
