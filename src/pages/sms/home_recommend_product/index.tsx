...
import UpdateRecommendProductForm, { RecommendProductFormValueType } from './components/UpdateRecommendProductForm';
 ...
 * @param fields
 */
const handleUpdate = async (fields: RecommendProductFormValueType) => {
  const hide = message.loading('正在更新');
  try {
    await updateRecommendProduct({
      name: fields.name,
    ...
    <PageContainer>
      ...
      <ModalForm
        ...
        onFinish={async (value) => {
          const success = await handleAdd(value as RecommendProductListItem);
          if (success) {
