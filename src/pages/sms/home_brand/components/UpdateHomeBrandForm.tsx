...
export interface HomeBrandFormValueType extends Partial<HomeBrandListItem> {
  target?: string;
  template?: string;
  type?: string;
  time?: string;
...
export interface UpdateHomeBrandFormProps {
  onCancel: (flag?: boolean, formVals?: HomeBrandFormValueType) => void;
  onSubmit: (values: HomeBrandFormValueType) => Promise<void>;
  updateModalVisible: boolean;
  values: Partial<HomeBrandListItem>;
}

const UpdateHomeBrandForm: React.FC<UpdateHomeBrandFormProps> = (props) => {
