...
import UpdateRecommendSubjectForm, { RecommendSubjectFormValueType } from './components/UpdateRecommendSubjectForm';
 ...
 * @param fields
 */
const handleUpdate = async (fields: RecommendSubjectFormValueType) => {
  const hide = message.loading('正在更新');
  try {
    await updateRecommendSubject({
      name: fields.name,
    ...
    <PageContainer>
      ...
      <ModalForm
        ...
        onFinish={async (value) => {
          const success = await handleAdd(value as RecommendSubjectListItem);
          if (success) {
