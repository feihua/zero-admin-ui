...
export interface HomeNewProductFormValueType extends Partial<HomeNewProductListItem> {
  target?: string;
  template?: string;
  type?: string;
  time?: string;
...
export interface UpdateHomeNewProductFormProps {
  onCancel: (flag?: boolean, formVals?: HomeNewProductFormValueType) => void;
  onSubmit: (values: HomeNewProductFormValueType) => Promise<void>;
  updateModalVisible: boolean;
  values: Partial<HomeNewProductListItem>;
}

const UpdateHomeNewProductForm: React.FC<UpdateHomeNewProductFormProps> = (props) => {
